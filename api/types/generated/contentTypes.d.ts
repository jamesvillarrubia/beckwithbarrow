...
export interface ApiAboutAbout extends Struct.SingleTypeSchema {
  ...
  info: {
    description: 'About page with 2x2 grid layout';
    displayName: 'About';
    pluralName: 'abouts';
    singularName: 'about';
  };
  ...
  attributes: {
    bottomLeftText: Schema.Attribute.RichText;
    ...
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::about.about'> &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    title: Schema.Attribute.String & Schema.Attribute.DefaultTo<'Who we are'>;
    topLeftImage: Schema.Attribute.Media<'images'>;
    topRightText: Schema.Attribute.RichText;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiHomeHome extends Struct.SingleTypeSchema {
  ...
  info: {
    description: 'Manage the home page content and layout';
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::home.home'> &
      Schema.Attribute.Private;
    numberColors: Schema.Attribute.String &
      Schema.Attribute.CustomField<'plugin::color-picker.color'>;
...
export interface ApiMenuMenu extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::menu.menu'> &
      Schema.Attribute.Private;
    menuItem: Schema.Attribute.Component<'shared.navigation-link', true>;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiPressPress extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::press.press'> &
      Schema.Attribute.Private;
    pressArticles: Schema.Attribute.Relation<
      'oneToMany',
      'api::press-article.press-article'
    >;
    publishedAt: Schema.Attribute.DateTime;
